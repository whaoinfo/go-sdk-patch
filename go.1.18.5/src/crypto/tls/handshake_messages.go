...
func (m *clientHelloMsg) marshal() []byte {
	...
	b.AddUint24LengthPrefixed(func(b *cryptobyte.Builder) {
		...
		b.AddUint16LengthPrefixed(func(b *cryptobyte.Builder) {
			...
			if fetchClientNewExtensions != nil {
				for _, extension := range fetchClientNewExtensions(m.sessionId) {
					b.AddUint16(extension.GetExtensionType())
					b.AddUint16LengthPrefixed(func(b *cryptobyte.Builder) {
						b.AddBytes(extension.GetExtensionData())
					})
				}
			}
...
func (m *serverHelloMsg) marshal() []byte {
	...
	b.AddUint24LengthPrefixed(func(b *cryptobyte.Builder) {
		...
		b.AddUint16LengthPrefixed(func(b *cryptobyte.Builder) {
			...
			if fetchServerNewExtensions != nil {
				for _, extension := range fetchServerNewExtensions(m.sessionId) {
					b.AddUint16(extension.GetExtensionType())
					b.AddUint16LengthPrefixed(func(b *cryptobyte.Builder) {
						b.AddBytes(extension.GetExtensionData())
					})
